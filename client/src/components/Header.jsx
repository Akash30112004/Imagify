...
const Header = () => {
  ...
  return (
    ...
    >
        ...
        >
            <p>Best text to generate images</p>
            <img src={assets.star_icon} alt="" />
        </motion.div>
        <motion.h1 className='text-4xl max-w-100 sm:text-6xl sm:w-120 mx-auto mt-10 text-center'>Turn text to <span className='text-blue-600'
        initial = {{opacity: 0}}
        animate = {{opacity: 1, y: 0}}
